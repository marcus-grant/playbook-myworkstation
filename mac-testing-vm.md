# MacOS VirtualBox VM Setup Notes

>This is taken from Jeff Geerling's [guide](https://github.com/geerlingguy/macos-virtualbox-vm) repo for doing the same thing.
